...
//資料內容
dataDescription=data.records.datasetDescription
...
//資料類型有五種
let wx = data.records.location[0].weatherElement[0];
let pop = data.records.location[0].weatherElement[1];
let mint = data.records.location[0].weatherElement[2];
let ci = data.records.location[0].weatherElement[3];
let maxt = data.records.location[0].weatherElement[4];
